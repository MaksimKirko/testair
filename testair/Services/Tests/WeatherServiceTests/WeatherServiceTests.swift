...
final class WeatherServiceTests: XCTestCase {
    class MockWeatherClient: WeatherClient {
        ...
        func getCondition(for city: String) -> URLRequest {
            return URLRequest(url: Bundle.module.url(forResource: filename, withExtension: "json")!)
        }
    }
    ...
    static var allTests = [
        ("testUrl", testUrl),
        ("testGetCurrentCondition", testGetCurrentCondition),
        ("testGetCurrentConditionWithError", testGetCurrentConditionWithError),
    ]
}
